...
public final class ManagerServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "ClientToManager.ManagerService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      ClientToManager.ImgServInfo> getGetServerMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetServer",
      requestType = com.google.protobuf.Empty.class,
      responseType = ClientToManager.ImgServInfo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protobuf.Empty,
      ClientToManager.ImgServInfo> getGetServerMethod() {
    io.grpc.MethodDescriptor<com.google.protobuf.Empty, ClientToManager.ImgServInfo> getGetServerMethod;
    if ((getGetServerMethod = ManagerServiceGrpc.getGetServerMethod) == null) {
      synchronized (ManagerServiceGrpc.class) {
        if ((getGetServerMethod = ManagerServiceGrpc.getGetServerMethod) == null) {
          ManagerServiceGrpc.getGetServerMethod = getGetServerMethod =
              io.grpc.MethodDescriptor.<com.google.protobuf.Empty, ClientToManager.ImgServInfo>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ClientToManager.ImgServInfo.getDefaultInstance()))
              .setSchemaDescriptor(new ManagerServiceMethodDescriptorSupplier("GetServer"))
              .build();
        }
      }
    }
   ...
   */
  public static ManagerServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ManagerServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ManagerServiceBlockingV2Stub>() {
        @java.lang.Override
        public ManagerServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new ManagerServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return ManagerServiceBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
    ...
    default void getServer(com.google.protobuf.Empty request,
        io.grpc.stub.StreamObserver<ClientToManager.ImgServInfo> responseObserver) {
   ...
   */
  public static final class ManagerServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<ManagerServiceBlockingV2Stub> {
    private ManagerServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ManagerServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ManagerServiceBlockingV2Stub(channel, callOptions);
    }
    ...
    /**
     */
    public ClientToManager.ImgServInfo getServer(com.google.protobuf.Empty request) throws io.grpc.StatusException {
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service ManagerService.
   */
  public static final class ManagerServiceBlockingStub
    ...
    /**
     */
    public ClientToManager.ImgServInfo getServer(com.google.protobuf.Empty request) {
  ...
  public static final class ManagerServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ClientToManager.ImgServInfo> getServer(
  ...
  private static abstract class ManagerServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ClientToManager.ClientToManagerProto.getDescriptor();
    }
