...
import clientToImageServiceStubs.DataImage;
...
public class ImageHandler extends ClienToImageserverGrpc.ClientToImageserverImplBase {


    private final Jedis jedis;


    public ImageHandler(Jedis jedis) {
        this.jedis = jedis;
    }
